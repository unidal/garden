...
<jsp:useBean id="ctx" type="org.unidal.tulip.security.user.page.Context" scope="request"/>
<jsp:useBean id="payload" type="org.unidal.tulip.security.user.page.Payload" scope="request"/>
<jsp:useBean id="model" type="org.unidal.tulip.security.user.page.Model" scope="request"/>
